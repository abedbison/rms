...
All Servlet must be made as slim as possible. 

Create service layer, then use it on servlet

Create database.properties for testUnit

JSP page on deleting item doesn't give the right value

Refactor Optional.isPresent() at LoginServlet
